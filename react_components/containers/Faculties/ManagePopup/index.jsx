...
import { closeManagePopup, addFaculty, editFaculty, deleteFaculty } from '../reducer';
import './index.scss';
    ...
    render() {
        ...
        return (
            <Modal show={show} onHide={this.closePopup}>
                ...
                <Modal.Body>
                    <Grid fluid className='manage-popup faculties'>
                        <div className='add'>
                            <Input
...
export default connect(
    ...
    { closePopup: closeManagePopup, add: addFaculty, edit: editFaculty, remove: deleteFaculty }
)(ManagePopup);
